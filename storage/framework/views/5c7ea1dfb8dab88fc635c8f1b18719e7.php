...
<body>
    ...
    <header class="navbar navbar-expand-lg navbar-dark bg-gradient-custom shadow-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand text-white d-flex align-items-center" href="#">
                <img src="<?php echo e(asset('images/inaklug.png')); ?>" alt="Inaklug Logo" class="d-inline-block align-text-top" height="50">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item"><a class="nav-link text-white <?php if(Route::currentRouteName() == 'home'): ?> navbar-active <?php endif; ?>" href="<?php echo e(route('home')); ?>">Home</a></li>
                    <li class="nav-item"><a class="nav-link text-white <?php if(Route::currentRouteName() == 'tentangKami'): ?> navbar-active <?php endif; ?>" href="<?php echo e(route('tentangKami')); ?>">Tentang Kami</a></li>
                    <li class="nav-item"><a class="nav-link text-white <?php if(Route::currentRouteName() == 'layananKami'): ?> navbar-active <?php endif; ?>" href="<?php echo e(route('layananKami')); ?>">Layanan</a></li>
                    <li class="nav-item"><a class="nav-link text-white <?php if(Route::currentRouteName() == 'artikel'): ?> navbar-active <?php endif; ?>" href="<?php echo e(route('artikel')); ?>">Artikel</a></li>
                    <li class="nav-item"><a class="nav-link text-white <?php if(Route::currentRouteName() == 'hubungi'): ?> navbar-active <?php endif; ?>" href="<?php echo e(route('hubungi')); ?>">Hubungi Kami</a></li>
                </ul>
    ...
    <main> 
        <div class="container-fluid position-relative" style="height: 450px; padding: 0;">
            <img src="<?php echo e(asset('images/picgedung.png')); ?>" alt="" class="position-absolute top-0 start-0 w-100 h-100" style="object-fit: cover;min-height:100vh !important">
            
            <div class="position-absolute d-flex align-items-start bg-gradient-custom text-white" style="left: 5%; bottom: -10%; width: 90%; max-width: 540px; ">
                            
                <div class="ms-4 bg-white me-2" style="height: 70px; width: 1px;"></div>
                <div class="d-flex py-4 pe-4">
                    <h1 class="fs-5 mb-0 flex-grow-1 ps-2 pe-2 text-center text-md-start">
                        INGIN KULIAH DAN BERKARIR DI LUAR NEGERI?
                    </h1>
                    <button class="d-flex align-items-center text-white btn btn-outline-light ms-1 px-4 py-1 mt-2 mt-md-0 rounded-pill" style="font-size: 0.8em;">
                        SELENGKAPNYA
        ...
        <div class="container py-5 text-muted" style="max-width: 80%;">
            <h1 class="mt-3 mb-5 fs-4 text-center">Layanan Kami</h1>    
            <div class="row text-center">
                <div class="col-md-4 mb-4">
                    <div class="card" style="height:260px">
                        <div class="image-overlay" style="height: 100%">
                            <img src="<?php echo e(asset('images/bachelor.png')); ?>" class="card-img" alt="Studi S1 - Bachelor">
                            <div class="overlay-content" style="top:0px !important">
                                <div class="line mb-4" style="height:210px"></div>
                            </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card" style="height:260px">
                        <div class="image-overlay" style="height: 100%">
                            <img src="<?php echo e(asset('images/master.png')); ?>" class="card-img" alt="Studi S2 - Master">
                            <div class="overlay-content" style="top:0px !important">
                                <div class="line mb-4" style="height:210px"></div>
                            </div>
                            <div class="overlay-content">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card" style="height:260px">
                        <div class="image-overlay" style="height: 100%">
                            <img src="<?php echo e(asset('images/phd.jpg')); ?>" class="card-img" alt="Studi S3 - Ph.D">
                            <div class="overlay-content" style="top:0px !important">
                                <div class="line mb-4" style="height:210px"></div>
                            </div>
                            <div class="overlay-content">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card" style="height:260px">
                        <div class="image-overlay" style="height: 100%">
                            <img src="<?php echo e(asset('images/kursus.png')); ?>" class="card-img" alt="Kursus Bahasa Asing">
                            <div class="overlay-content" style="top:0px !important">
                                <div class="line mb-4" style="height:210px"></div>
                            </div>
                            <div class="overlay-content">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card" style="height:260px">
                        <div class="image-overlay" style="height: 100%">
                            <img src="<?php echo e(asset('images/studytour.png')); ?>" class="card-img" alt="Study Tour">
                            <div class="overlay-content" style="top:0px !important">
                                <div class="line mb-4" style="height:210px"></div>
                            </div>
                            <div class="overlay-content">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card" style="height:260px">
                        <div class="image-overlay" style="height: 100%">
                            <img src="<?php echo e(asset('images/ausbildung.jpg')); ?>" class="card-img" alt="Ausbildung">
                            <div class="overlay-content" style="top:0px !important">
                                <div class="line mb-4" style="height:210px"></div>
                            </div>
                            <div class="overlay-content">
        ...
        <div class="container py-5 text-muted" style="max-width: 860px;">
            ...
            <div class="logo-container">
                <div class="logo-box">
                    <img src="<?php echo e(asset('images/aviation.jpg')); ?>" alt="424 Aviation">
                </div>
                <div class="logo-box">
                    <img src="<?php echo e(asset('images/adrew.png')); ?>" alt="St. Andrew's College">
                </div>
                <div class="logo-box">
                    <img src="<?php echo e(asset('images/htw.png')); ?>" alt="HTW Berlin">
                </div>
                <div class="logo-box">
                    <img src="<?php echo e(asset('images/studygroup.png')); ?>" alt="Study Group">
                </div>
            </div>            
        </div>
        ...
        <div class="container py-5 text-muted" style="max-width: 70%;">
            <div class="d-flex flex-column flex-md-row align-items-center bg-gradient-custom text-white p-3" style="width: 100%; border-radius: 8px;">
                ...
                <div class="flex-grow-1 text-center text-md-start">
                    <h1 class="py-2 fs-5 mb-0 ps-md-2">GRATIS KONSELING STUDI DI LUAR NEGERI</h1>
            ...
            <div class="container text-center">
                ...
                <div class="article-grid">
                    ...
                    <div class="article-card">
                        <img src="<?php echo e(asset('images/studijerman.png')); ?>" alt="Artikel 1">
                        <div class="article-title">5 Fakta yang Harus Kamu Ketahui Sebelum Studi ke Jerman</div>
                    </div>
                    
                    <!-- Artikel 2 -->
                    <div class="article-card">
                        <img src="<?php echo e(asset('images/korona.png')); ?>" alt="Artikel 2">
                        <div class="article-title">Uni Eropa Menghadapi Virus Korona</div>
                    </div>
                    
                    <!-- Artikel 3 -->
                    <div class="article-card">
                        <img src="<?php echo e(asset('images/bahasajerman.png')); ?>" alt="Artikel 3">
                        <div class="article-title">Belajar Bahasa Jerman Bersama Goethe Institut</div>
                    </div>
                    
                    <!-- Artikel 4 -->
                    <div class="article-card">
                        <img src="<?php echo e(asset('images/gatescambride.png')); ?>" alt="Artikel 4">
                        <div class="article-title">Apa Itu Gates Cambridge? Yuk Cari Tahu</div>
                    </div>
                </div>
                
                <span class="btn mt-5 bg-gradient-custom rounded-5" style="padding:0.5px"><a href="#" class="hover bg-white btn px-5 py-2 rounded-5 "> LAINNYA</a></span>
            </div>
        </div>
...
</html><?php /**PATH F:\WEB\LARAGON\Laravel10-bootstrap\TB1-Web-Enterprise\resources\views/home.blade.php ENDPATH**/ ?>