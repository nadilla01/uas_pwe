...
<body>
    ...
    <main>
        ...
        <div class="w-100 position-relative" style="height: 450px;">
            <img src="{{ asset('images/pexels-photo-3184296.jpeg') }}" alt="" class="w-100 h-100" style="object-fit: cover;">
            ...
            <div class="position-absolute text-white" style="left: 20%; bottom:3%; width: 50%;">
                <h1 class="fs-4 mb-1">TIPS</h1>
                <p class=" h3">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri dengan Beasiswa</p>
            </div>
        </div>        
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="card border-0">
                            <img src="{{ asset('images/korona.png') }}" alt="Image 1" class="card-img-top rounded" style="object-fit: cover; height: 250px;">
                    ...
                    <div class="col-md-6">
                        <div class="card border-0">
                            <img src="{{ asset('images/htw.png') }}" alt="Image 2" class="card-img-top rounded" style="object-fit: cover; height: 250px;">
                            <div class="card-body p-2">
                                <p class="card-text text-center fw-bold">
                                    Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri dengan Beasiswa
                                </p>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <div class="card">
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="{{ asset('images/nurse2.jpg') }}" class="card-img" alt="Image 5">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Penting! Cara Mudah agar Bisa Kuliah di Luar Negeri dengan Beasiswa</h5>
