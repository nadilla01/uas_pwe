    ...
    <header class="navbar navbar-expand-lg navbar-dark bg-gradient-custom shadow-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand text-white d-flex align-items-center" href="#">
                <img src="{{ asset('images/inaklug.png') }}" alt="Inaklug Logo" class="d-inline-block align-text-top"
                    height="50">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item"><a
                            class="nav-link text-white @if (Route::currentRouteName() == 'home') navbar-active @endif"
                            href="{{ route('home') }}">Home</a></li>
                    <li class="nav-item"><a
                            class="nav-link text-white @if (Route::currentRouteName() == 'tentangKami') navbar-active @endif"
                            href="{{ route('tentangKami') }}">Tentang Kami</a></li>
                    <li class="nav-item"><a
                            class="nav-link text-white @if (Route::currentRouteName() == 'layananKami') navbar-active @endif"
                            href="{{ route('layananKami') }}">Layanan</a></li>
                    <li class="nav-item"><a
                            class="nav-link text-white @if (Route::currentRouteName() == 'artikel') navbar-active @endif"
                            href="{{ route('artikel') }}">Artikel</a></li>
                    <li class="nav-item"><a
                            class="nav-link text-white @if (Route::currentRouteName() == 'hubungi') navbar-active @endif"
                            href="{{ route('hubungi') }}">Hubungi Kami</a></li>
                </ul>
